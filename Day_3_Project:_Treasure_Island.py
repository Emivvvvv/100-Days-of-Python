...
q1 = input("Yor're at a cross road. Where do you want to go? Type \"left\" or \"right\"\n")
if q1 == "left":
    ...
    if q2 == "wait":
        ...
        if q3 == "yellow":
            print("You win! You find a Bitcoin wallet which has 10000 Bitcoin in it so you won't need to have a job anymore!\n")
        else:
            print("You died XP")
    else:
        print("You died XP")
